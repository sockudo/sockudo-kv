...
pub static CONFIG_TABLE: &[ConfigEntry] = &[
    ...
    ConfigEntry {
        ...
        alias: Some("repl-ping-slave-period"),
        flags: ConfigFlags::NONE,
        config_type: ConfigType::Integer,
        default_value: "10",
    ...
    ConfigEntry {
        ...
        alias: Some("slave-serve-stale-data"),
        flags: ConfigFlags::NONE,
        config_type: ConfigType::Bool,
        default_value: "yes",
    ...
    ConfigEntry {
        ...
        alias: Some("min-slaves-to-write"),
        flags: ConfigFlags::NONE,
        config_type: ConfigType::Integer,
        default_value: "0",
